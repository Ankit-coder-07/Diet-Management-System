               ...
               //  $nic = $_POST["nic"];
                ...
                if ($conn->connect_error) {
                    ...
                    if ($password != $cpassword) {
                        ...
                        $stmt = $conn->prepare("INSERT INTO register (FName, lname, Email, Password, phoneNumber, country, address) VALUES ('$first_name', '$last_name', '$email', '$password', '$phoneNumber', '$country', '$address')");
